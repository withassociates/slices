...
(function($) {
    ...
    var onprogress = $.support.ajaxProgress = ("onprogress" in $.ajaxSettings.xhr());
    var xhrBind = $.ajaxSettings.xhr.bind != undefined;
    var support = onprogress && xhrBind;
    ...
    newOptions.xhr = function () {
        ...
        if (newXhr) {
            newXhr.upload.onprogress = function(evt) {

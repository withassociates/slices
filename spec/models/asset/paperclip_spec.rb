...
describe Asset, type: :model do
  describe "paperclip" do
    ...
    context "#url_for" do
      ...
      it "returns the full url with all interpolations" do
        asset.url_for(:extended).split('?').first.
          should eq '/system/spec/files/ca0/5197526f33a39b871bd5eda640182/extended/lady_bird.jpg'
      end
